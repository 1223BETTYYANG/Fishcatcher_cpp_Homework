...
{/*
    QSound *startsound=new QSound("C:/Users/lenovo/Desktop/fishcatcher/fishcatcher/mui/Deepend.wav",this);
    startsound->play();
   ...
   //搞不出来了 this->setPalette(palette);
    ...
    fish5=new QFish_1(":/fi/img/pen/1.png",easyscene);
    fish6=new QFish_1(":/fi/img/pen/1.png",easyscene);
